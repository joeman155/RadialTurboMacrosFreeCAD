...
class Meridional:
	def __init__(self, obj):
		obj.Proxy = self
		obj.addProperty("App::PropertyFloat", "D2", "Dimensions", "Diameter of an impeller").D2=62.370
	...
	def execute (self, obj):
		...
		r0 = obj.d0/2.
		R0 = obj.D0/2.
		gap = 0.6        # The gap between the shroud of the impeller and the lid, this is filled in with the fluid we are creating here.
		th  = 1             # The thickness of the shroud
		relip = 0.315  # How far the fluid extends past impeller, BEFORE it expands to the 
		re  = 0.815         # How much further out the fluid extends
		v    = 0.5         # How far to come back from edge
		d    = 1           # Depth of flud 
          


		# Create points:
		shroudP1 = FreeCAD.Vector(0, R0+th,0)
		shroudP2 = FreeCAD.Vector(obj.L-th,R0+th,0)
		shroudP3 = FreeCAD.Vector(obj.L-th,(R2+R0)/2.+th,0)
		shroudP4 = FreeCAD.Vector(obj.L-th,R2,0)

		
		shroud2P1 = FreeCAD.Vector(0, R0+th+gap,0)
		shroud2P2 = FreeCAD.Vector(obj.L-th-gap,R0+th+gap,0)
		shroud2P3 = FreeCAD.Vector(obj.L-th-gap,(R2+R0)/2.+th+gap ,0)
		shroud2P4 = FreeCAD.Vector(obj.L-th-gap,R2,0)
