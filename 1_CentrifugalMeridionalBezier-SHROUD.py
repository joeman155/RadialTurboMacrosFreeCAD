...
class Meridional:
	...
	def execute (self, obj):
		...
		shroud2P1 = FreeCAD.Vector(0, R0+th,0)
		shroud2P2 = FreeCAD.Vector(obj.L-th,R0+th,0)
		shroud2P3 = FreeCAD.Vector(obj.L-th,(R2+R0)/2.+th,0)
		shroud2P4 = FreeCAD.Vector(obj.L-th,R2,0)
